...
class PaisaTrackerRepository(
 ...
 suspend fun deleteSalaryRecord(r: SalaryRecord) = salaryRecordDao.delete(r)
     ...
     */
    fun getMonthlyTotals(months: Int = 12): Flow<List<com.h4rsh41.paisatracker.domain.models.MonthlyTotal>> =
     ...
     */
    fun getYearlyTotals(): Flow<List<com.h4rsh41.paisatracker.domain.models.YearlyTotal>> =
    ...
    fun getCategorySpendingByDateRange(
        startDate: Long,
        endDate: Long
    ): Flow<List<com.h4rsh41.paisatracker.domain.models.CategorySpending>> =
     ...
     */
    fun getMonthlyTotalsForYear(year: String): Flow<List<com.h4rsh41.paisatracker.domain.models.MonthlyTotal>> =
